...
//     uint128 constant MAX_DISTANCE = 100_000;
...
//     function testComputeTrustScore_MaxScoreWhenLocationsIdentical()
//         external
//         view
//     {
...
//         uint128 score = logDefaultTrustPackage.computeTrustScore(payload);

//         assertEq(score, 100);
//     }

//     function testComputeTrustScore_ReducedScoreWhenLocationDistant()
//         external
//         view
//     {
//         LogData memory logData = LogData({
...
//     function testComputeTrustScore_ZeroScoreWhenDistanceBeyondMax()
//         external
//         view
//     {
//         LogData memory logData = LogData({
...
//         uint128 expectedScore = (WEIGHT_EVIDENCE_COMPLETENESS *
//             SCALE +
//             WEIGHT_PROVENANCE *
//             SCALE) / SCALE;
...
//         uint128 expectedScore = WEIGHT_PROVENANCE + WEIGHT_SPATIAL_PLAUSIBILITY;
//         assertEq(score, expectedScore);
//     }
...
//     function testComputeTrustScore_VerifiedCompliantButDistantLocation()
//         external
//         view
//     {
//         // Create a log far from the plot
//         int128 farLatitude = 20000000; // Approximately 1 degree away
//         int128 farLongitude = 105000000;
...
//     function testComputeTrustScore_MixedPositiveNegativeCoordinates()
//         external
//         view
//     {
//         LogData memory logData = LogData({
...
//                 latitude: type(int128).max,
//                 longitude: type(int128).max
//             }),
//             plotLocation: Location({
//                 latitude: type(int128).max - 1000,
//                 longitude: type(int128).max - 1000
//             })
//         });
