AUDIT_DEPLOYED_ADDRESS = 0xd8058efe0198ae9dd7d563e1b4938dcbc86a1f81 # always change
...
audit-request:
	cast send $(AUDIT_DEPLOYED_ADDRESS) "requestVerification(bytes32,uint64,uint256)" $(BYTES32_IDENTIFIER) 1 1771834498586 --private-key $(PRIVATE_KEY) --rpc-url $(RPC_URL)
...
audit-verify:
# 	cast send $(AUDIT_DEPLOYED_ADDRESS) "verify(bytes32,uint64,bool)" $(BYTES32_IDENTIFIER) 1 true --private-key 0x2a871d0798f97d79848a013d4936a73bf4cc922c825d33c1cf7073dff6d409c6 --rpc-url $(RPC_URL)
# 	cast send $(AUDIT_DEPLOYED_ADDRESS) "verify(bytes32,uint64,bool)" $(BYTES32_IDENTIFIER) 1 true --private-key 0xdbda1821b80551c9d65939329250298aa3472ba22feea921c0cf5d620ea67b97 --rpc-url $(RPC_URL)
# 	cast send $(AUDIT_DEPLOYED_ADDRESS) "verify(bytes32,uint64,bool)" $(BYTES32_IDENTIFIER) 1 false --private-key 0x4bbbf85ce3377467afe5d46f804f221813b2bb87f24d81f60f1fcdbf7cbf4356 --rpc-url $(RPC_URL)
	cast send $(AUDIT_DEPLOYED_ADDRESS) "verify(bytes32,uint64,bool)" $(BYTES32_IDENTIFIER) 1 true --private-key 0x92db14e403b83dfe3df233f83dfa3a0d7096f21ca9b0d6d6b8d88b2b4ec1564e --rpc-url $(RPC_URL)
# 	cast send $(AUDIT_DEPLOYED_ADDRESS) "verify(bytes32,uint64,bool)" $(BYTES32_IDENTIFIER) 1 true --private-key 0x8b3a350cf5c34c9194ca85829a2df0ec3153be0318b5e2d3348e872092edffba --rpc-url $(RPC_URL)
# 	cast send $(AUDIT_DEPLOYED_ADDRESS) "verify(bytes32,uint64,bool)" $(BYTES32_IDENTIFIER) 1 false --private-key 0x47e179ec197488593b187f80a00eb0da91f1b9d0b13f8733639f19c30a34926a --rpc-url $(RPC_URL)
