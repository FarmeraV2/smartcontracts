...
contract Interaction is Script, CodeConstants {
    ...
    function run() external {
        ...
        console.log(
            "LogDefaultPackage deployed at:",
            address(logDefaultPackage)
        );

        LogAuditorPackage logAuditorPackage = new LogAuditorPackage(
            address(auditorRegistry)
        );
        console.log(
            "LogAuditorPackage deployed at:",
            address(logAuditorPackage)
        );
